...
// /// Flags attribute
// /**
//  * inactive: Flag is not set and will not be parsed
//  * hidden:   Flag is active, but will not show up in the help message
//  * required: Flag must be set on the command line. Otherwise an exception will be thrown
//  * optional: Flag must not be set. Default attribute.
//  * advanced: Flag is advanced and will only show up in the advanced help message
//  * expoert:  Flag is expert and will only show up in the expert help message
//  */
...
// /// Flag name type. Used in invalid_option exception.
// /**
//  * unspecified: not specified
//  * short_name:  The flag's short name
//  * long_name:   The flag's long name
//  */
// enum class FlagName
// {
//     unspecified,
...
//  * Flag is not bound to a special type "T"
//  */
// class Flag
// {
...
//     Flag(const std::string& short_name, const std::string& long_name, const std::string& description);
...
//     /// Get the Flag's short name
//     /// @return character of the options's short name or 0 if no short name is defined
//     char short_name() const;

//     /// Get the Flag's long name
//     /// @return the long name of the Flag. Empty string if no long name is defined
//     std::string long_name() const;

//     /// Get the Flag's long or short name
//     /// @param what_name the option's name to return
//     /// @param what_hyphen preced the returned name with (double-)hypen
//     /// @return the requested name of the Flag. Empty string if not defined.
...
// /// FlagsParser manages all Flags
// /**
//  * FlagsParser manages all Flags
//  * Add Flags (Flag_Type = Value<T>, Implicit<T> or Switch) with "add<Flag_Type>(option params)"
...
// {
// public:
//     /// Construct the FlagsParser
//     /// @param description used for the help message
//     explicit FlagsParser(std::string description = "");

//     /// Destructor
//     virtual ~FlagsParser() = default;
